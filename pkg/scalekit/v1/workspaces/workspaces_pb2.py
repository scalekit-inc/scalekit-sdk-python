...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'Z<github.com/scalekit_sdk-inc/scalekit_sdk/pkg/grpc/workspaces'
