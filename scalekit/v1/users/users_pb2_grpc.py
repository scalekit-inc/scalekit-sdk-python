...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetCurrentUser = channel.unary_unary(
                ...
                response_deserializer=scalekit_dot_v1_dot_users_dot_users__pb2.GetCurrentUserResponse.FromString,
                )
        self.GetSupportHash = channel.unary_unary(
                '/scalekit.v1.users.UserService/GetSupportHash',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=scalekit_dot_v1_dot_users_dot_users__pb2.GetSupportHashResponse.FromString,
                )
...
class UserServiceServicer(object):
    ...
    def GetSupportHash(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetCurrentUser': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=scalekit_dot_v1_dot_users_dot_users__pb2.GetCurrentUserResponse.SerializeToString,
            ),
            'GetSupportHash': grpc.unary_unary_rpc_method_handler(
                    servicer.GetSupportHash,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=scalekit_dot_v1_dot_users_dot_users__pb2.GetSupportHashResponse.SerializeToString,
            ),
...
class UserService(object):
    ...
    def GetCurrentUser(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/scalekit.v1.users.UserService/GetCurrentUser',
            ...
            scalekit_dot_v1_dot_users_dot_users__pb2.GetCurrentUserResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def GetSupportHash(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/scalekit.v1.users.UserService/GetSupportHash',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            scalekit_dot_v1_dot_users_dot_users__pb2.GetSupportHashResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
