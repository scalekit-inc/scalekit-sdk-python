...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ROLESSERVICE'].methods_by_name['GetRoleUsersCount']._serialized_options = b'\202\265\030\002\030T\372\322\344\223\002\t\022\007PREVIEW\202\323\344\223\002\211\001\022\036/api/v1/roles/{id}/users:countZ/\022-/api/v1/environments/-/roles/{id}/users:countZ6\0224/api/v1/environments/{env_id}/roles/{id}/users:count'
