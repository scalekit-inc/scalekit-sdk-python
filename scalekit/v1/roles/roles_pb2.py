...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ROLESSERVICE'].methods_by_name['CreateOrganizationRole']._serialized_options = b'\222A\343\001\n\004Role\022\036Create a new Organization Role\032SCreate a new organization role to represent a specific role within the organizationJf\n\003201\022_\n&Organization Role created successfully\0225\n3\0321.scalekit.v1.roles.CreateOrganizationRoleResponse\202\265\030\002\030T\202\323\344\223\002,\"$/api/v1/organizations/{org_id}/roles:\004role'
  _globals['_ROLESSERVICE'].methods_by_name['UpdateOrganizationRole']._loaded_options = None
  _globals['_ROLESSERVICE'].methods_by_name['UpdateOrganizationRole']._serialized_options = b'\222A\326\001\n\004Role\022$Update an existing Organization Role\032@Update an existing organization role using its unique identifierJf\n\003200\022_\n&Organization Role updated successfully\0225\n3\0321.scalekit.v1.roles.UpdateOrganizationRoleResponse\202\265\030\002\030T\202\323\344\223\0021\032)/api/v1/organizations/{org_id}/roles/{id}:\004role'
  _globals['_ROLESSERVICE'].methods_by_name['GetOrganizationRole']._loaded_options = None
  _globals['_ROLESSERVICE'].methods_by_name['GetOrganizationRole']._serialized_options = b'\222A\355\001\n\004Role\022\032Retrieve Organization Role\032ZFetch detailed information about a specific organization role using its unique identifier.Jm\n\003200\022f\n0Successfully retrieved organization role details\0222\n0\032..scalekit.v1.roles.GetOrganizationRoleResponse\202\265\030\002\030t\202\323\344\223\002+\022)/api/v1/organizations/{org_id}/roles/{id}'
  _globals['_ROLESSERVICE'].methods_by_name['ListOrganizationRoles']._loaded_options = None
  _globals['_ROLESSERVICE'].methods_by_name['ListOrganizationRoles']._serialized_options = b'\222A\271\002\n\005Roles\022\033List All Organization Roles\032\212\001Retrieve a paginated list of all roles within the organization. Use the page_token from the response to access subsequent pages of resultsJ\205\001\n\003200\022~\nFSuccessfully retrieved the list of roles within the given organization\0224\n2\0320.scalekit.v1.roles.ListOrganizationRolesResponse\202\265\030\002\030t\202\323\344\223\002&\022$/api/v1/organizations/{org_id}/roles'
  _globals['_ROLESSERVICE'].methods_by_name['DeleteOrganizationRole']._loaded_options = None
  _globals['_ROLESSERVICE'].methods_by_name['DeleteOrganizationRole']._serialized_options = b'\222A\215\001\n\004Role\022\033Delete an Organization Role\032IRemove an existing role from the organization using its unique identifierJ\035\n\003200\022\026\n\024Deleted Successfully\202\265\030\002\030T\202\323\344\223\002+*)/api/v1/organizations/{org_id}/roles/{id}'
  ...
  _globals['_ROLESSERVICE']._serialized_end=7058
