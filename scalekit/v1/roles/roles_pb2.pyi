...
class PermissionType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    ALL: _ClassVar[PermissionType]
    SCALEKIT: _ClassVar[PermissionType]
    ENVIRONMENT: _ClassVar[PermissionType]
ALL: PermissionType
SCALEKIT: PermissionType
ENVIRONMENT: PermissionType
...
class ListPermissionsRequest(_message.Message):
    __slots__ = ("page_token", "page_size", "type")
    ...
    page_size: int
    type: PermissionType
    def __init__(self, page_token: _Optional[str] = ..., page_size: _Optional[int] = ..., type: _Optional[_Union[PermissionType, str]] = ...) -> None: ...
