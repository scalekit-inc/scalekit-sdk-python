...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_AUTHMETHOD'].fields_by_name['enable_webauthn_auto_registration']._loaded_options = None
  _globals['_AUTHMETHOD'].fields_by_name['enable_webauthn_auto_registration']._serialized_options = b'\222AP2GIndicates if WebAuthn auto-registration is enabled for this auth method:\005false'
  _globals['_AUTHMETHOD'].fields_by_name['show_passkey_button']._loaded_options = None
  _globals['_AUTHMETHOD'].fields_by_name['show_passkey_button']._serialized_options = b'\222A+2#Show passkey button on login screen:\004true'
  _globals['_AUTHMETHOD'].fields_by_name['enable_webauthn_conditional_login']._loaded_options = None
  _globals['_AUTHMETHOD'].fields_by_name['enable_webauthn_conditional_login']._serialized_options = b'\222A02(Allow autofill of passkeys in login page:\004true'
  ...
  _globals['_DISCOVERYREQUEST'].fields_by_name['g_recaptcha_response']._loaded_options = None
  _globals['_DISCOVERYREQUEST'].fields_by_name['g_recaptcha_response']._serialized_options = b'\222A\241\0012\206\001reCAPTCHA v2 response token from the client widget. Omit when recaptcha_skip_login_signup flag is enabled or the widget fails to load.J\026\"03AGdBq24...token...\"'
  ...
  _globals['_PORTALSETTINGS'].fields_by_name['mcp_consent_screen_v2']._serialized_options = b'\222A\216\0012\204\001Indicates whether the MCP consent screen should use the two-column layout (rollout-driven). Present only for consent-screen requestsJ\005false'
  ...
  _globals['_GETAUTHCUSTOMIZATIONSRESPONSE'].fields_by_name['organization_customizations']._loaded_options = None
  _globals['_GETAUTHCUSTOMIZATIONSRESPONSE'].fields_by_name['organization_customizations']._serialized_options = b'\340A\003'
  ...
  _globals['_OTPREQUEST'].fields_by_name['g_recaptcha_response']._loaded_options = None
  _globals['_OTPREQUEST'].fields_by_name['g_recaptcha_response']._serialized_options = b'\222A\241\0012\206\001reCAPTCHA v2 response token from the client widget. Omit when recaptcha_skip_login_signup flag is enabled or the widget fails to load.J\026\"03AGdBq24...token...\"'
  _globals['_RESENDAUTHPASSWORDLESSREQUEST'].fields_by_name['g_recaptcha_response']._loaded_options = None
  _globals['_RESENDAUTHPASSWORDLESSREQUEST'].fields_by_name['g_recaptcha_response']._serialized_options = b'\222A\241\0012\206\001reCAPTCHA v2 response token from the client widget. Omit when recaptcha_skip_login_signup flag is enabled or the widget fails to load.J\026\"03AGdBq24...token...\"'
  ...
  _globals['_ORGANIZATION'].fields_by_name['logo_url']._loaded_options = None
  _globals['_ORGANIZATION'].fields_by_name['logo_url']._serialized_options = b'\222A\237\0012_HTTPS URL of the organization\'s logo image. Maximum 2048 characters. Must use the https scheme.J\'\"https://cdn.example.com/acme-logo.png\"x\200\020\212\001\t^https://\242\002\003uri\272H\005r\003\030\200\020'
  ...
  _globals['_AUTHSERVICE'].methods_by_name['ListAuthMethods']._serialized_options = b'\202\265\030\002\030\001\372\322\344\223\002\t\022\007PREVIEW\202\323\344\223\002\025\022\023/api/v1/authmethods'
  _globals['_AUTHSERVICE'].methods_by_name['DiscoveryAuthMethod']._loaded_options = None
  _globals['_AUTHSERVICE'].methods_by_name['DiscoveryAuthMethod']._serialized_options = b'\202\265\030\002\030\001\372\322\344\223\002\t\022\007PREVIEW\202\323\344\223\002+\"\026/api/v1/auth:discovery:\021discovery_request'
  _globals['_AUTHSERVICE'].methods_by_name['VerifyPasswordLessOtp']._loaded_options = None
  _globals['_AUTHSERVICE'].methods_by_name['VerifyPasswordLessOtp']._serialized_options = b'\202\265\030\002\030\001\372\322\344\223\002\t\022\007PREVIEW\202\323\344\223\002+\" /api/v1/auth/passwordless:verify:\007otp_req'
  _globals['_AUTHSERVICE'].methods_by_name['ResendAuthPasswordless']._loaded_options = None
  _globals['_AUTHSERVICE'].methods_by_name['ResendAuthPasswordless']._serialized_options = b'\202\265\030\002\030\001\372\322\344\223\002\t\022\007PREVIEW\202\323\344\223\002%\" /api/v1/auth/passwordless:resend:\001*'
  _globals['_AUTHSERVICE'].methods_by_name['ListUserOrganizations']._loaded_options = None
  _globals['_AUTHSERVICE'].methods_by_name['ListUserOrganizations']._serialized_options = b'\202\265\030\002\030\001\372\322\344\223\002\t\022\007PREVIEW\202\323\344\223\002\034\022\032/api/v1/auth:organizations'
  _globals['_AUTHSERVICE'].methods_by_name['SignupOrganization']._loaded_options = None
  _globals['_AUTHSERVICE'].methods_by_name['SignupOrganization']._serialized_options = b'\202\265\030\002\030\001\372\322\344\223\002\t\022\007PREVIEW\202\323\344\223\002\030\"\023/api/v1/auth:signup:\001*'
  _globals['_AUTHSERVICE'].methods_by_name['GetAuthState']._loaded_options = None
  _globals['_AUTHSERVICE'].methods_by_name['GetAuthState']._serialized_options = b'\202\265\030\002\030\001\372\322\344\223\002\t\022\007PREVIEW\202\323\344\223\002\024\022\022/api/v1/auth/state'
  _globals['_AUTHSERVICE'].methods_by_name['GetAuthError']._loaded_options = None
  _globals['_AUTHSERVICE'].methods_by_name['GetAuthError']._serialized_options = b'\202\265\030\002\030\001\372\322\344\223\002\t\022\007PREVIEW\202\323\344\223\002<\022\031/api/v1/errors/{error_id}Z\037\022\035/api/v1/auth/error/{error_id}'
  _globals['_AUTHSERVICE'].methods_by_name['Logout']._loaded_options = None
  _globals['_AUTHSERVICE'].methods_by_name['Logout']._serialized_options = b'\202\265\030\002\030\001\372\322\344\223\002\t\022\007PREVIEW\202\323\344\223\002\025\"\023/api/v1/auth/logout'
  _globals['_AUTHSERVICE'].methods_by_name['GetAuthCustomizations']._loaded_options = None
  _globals['_AUTHSERVICE'].methods_by_name['GetAuthCustomizations']._serialized_options = b'\202\265\030\002\030\001\372\322\344\223\002\t\022\007PREVIEW\202\323\344\223\002\035\022\033/api/v1/auth:customizations'
  ...
  _globals['_INTENT']._serialized_start=9080
  _globals['_INTENT']._serialized_end=9138
  _globals['_AUTHSTATE']._serialized_start=9141
  _globals['_AUTHSTATE']._serialized_end=9705
  ...
  _globals['_AUTHMETHOD']._serialized_end=1727
  _globals['_DISCOVERYAUTHMETHODREQUEST']._serialized_start=1729
  _globals['_DISCOVERYAUTHMETHODREQUEST']._serialized_end=1838
  _globals['_DISCOVERYREQUEST']._serialized_start=1841
  _globals['_DISCOVERYREQUEST']._serialized_end=2239
  _globals['_DISCOVERYAUTHMETHODRESPONSE']._serialized_start=2241
  _globals['_DISCOVERYAUTHMETHODRESPONSE']._serialized_end=2333
  _globals['_GETAUTHCUSTOMIZATIONSREQUEST']._serialized_start=2335
  _globals['_GETAUTHCUSTOMIZATIONSREQUEST']._serialized_end=2365
  _globals['_PORTALSETTINGS']._serialized_start=2368
  _globals['_PORTALSETTINGS']._serialized_end=2999
  _globals['_GETAUTHCUSTOMIZATIONSRESPONSE']._serialized_start=3002
  _globals['_GETAUTHCUSTOMIZATIONSRESPONSE']._serialized_end=3336
  _globals['_GETAUTHFEATURESRESPONSE']._serialized_start=3338
  _globals['_GETAUTHFEATURESRESPONSE']._serialized_end=3416
  _globals['_VERIFYPASSWORDLESSOTPREQUEST']._serialized_start=3418
  _globals['_VERIFYPASSWORDLESSOTPREQUEST']._serialized_end=3503
  _globals['_VERIFYPASSWORDLESSOTPRESPONSE']._serialized_start=3505
  _globals['_VERIFYPASSWORDLESSOTPRESPONSE']._serialized_end=3536
  _globals['_OTPREQUEST']._serialized_start=3539
  _globals['_OTPREQUEST']._serialized_end=3863
  _globals['_RESENDAUTHPASSWORDLESSREQUEST']._serialized_start=3866
  _globals['_RESENDAUTHPASSWORDLESSREQUEST']._serialized_end=4116
  _globals['_LISTUSERORGANIZATIONSRESPONSE']._serialized_start=4119
  _globals['_LISTUSERORGANIZATIONSRESPONSE']._serialized_end=4331
  _globals['_ORGANIZATION']._serialized_start=4334
  _globals['_ORGANIZATION']._serialized_end=5077
  _globals['_USERDETAILS']._serialized_start=5079
  _globals['_USERDETAILS']._serialized_end=5174
  _globals['_SIGNUPORGANIZATIONREQUEST']._serialized_start=5177
  _globals['_SIGNUPORGANIZATIONREQUEST']._serialized_end=5373
  _globals['_SIGNUPORGANIZATIONRESPONSE']._serialized_start=5375
  _globals['_SIGNUPORGANIZATIONRESPONSE']._serialized_end=5489
  _globals['_UPDATELOGINUSERDETAILSREQUEST']._serialized_start=5492
  _globals['_UPDATELOGINUSERDETAILSREQUEST']._serialized_end=5834
  _globals['_UPDATELOGINUSERDETAILSRESPONSE']._serialized_start=5837
  _globals['_UPDATELOGINUSERDETAILSRESPONSE']._serialized_end=6047
  _globals['_USER']._serialized_start=6050
  _globals['_USER']._serialized_end=8536
  _globals['_GETAUTHSTATERESPONSE']._serialized_start=8539
  _globals['_GETAUTHSTATERESPONSE']._serialized_end=8844
  _globals['_GETAUTHERRORREQUEST']._serialized_start=8847
  _globals['_GETAUTHERRORREQUEST']._serialized_end=8987
  _globals['_GETAUTHERRORRESPONSE']._serialized_start=8989
  _globals['_GETAUTHERRORRESPONSE']._serialized_end=9078
  _globals['_AUTHSERVICE']._serialized_start=9708
  _globals['_AUTHSERVICE']._serialized_end=11985
