...
class GetMcpInstanceResponse(BaseModel):
    """Response model for fetching a single MCP instance."""

    instance: Optional[McpInstance] = Field(
        None,
        description="The requested MCP instance",
    )

    @classmethod
    def from_proto(cls, proto_response) -> "GetMcpInstanceResponse":
        instance = None
